//---------------------------------------------------------------------------------------------------
//@file	N:\Documents\Soul Engine\Source Files\Ray Engine\RayEngine.h.
//Declares the ray engine class.
...
namespace RayEngine {
	...
	//function to initialize all its rays and returns the tag that can be used to extract the data
	//in 'UpdateLate'.
