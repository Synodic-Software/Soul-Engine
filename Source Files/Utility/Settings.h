//---------------------------------------------------------------------------------------------------
//@file	N:\Documents\Soul Engine\Source Files\Utility\Settings.h.
...
//.
	namespace detail {
		...
		//---------------------------------------------------------------------------------------------------
		//Simple wrapper around table to allow dynamic creation of tables. This makes reading tables
		//from files easier and more efficient.
	...
	//---------------------------------------------------------------------------------------------------
	//Deletes all currently stored settings and reads new ones from _filename. T is a boost text,
	//XML, or binary iarchive.  Wide character archives are not supported.
	//@param	_filename	Filename of the file.
	//@param	type	 	(Optional) The type.
