...
void VulkanBackend::AddWindow(GLFWwindow* window){
...
void VulkanBackend::CreateImageViews() {
	swapChainImageViews.resize(swapChainImages.size(), VulkanWrapper<VkImageView>{device, vkDestroyImageView});
...
void VulkanBackend::CreateFrameBufferTextures(char* deviceM,int texWidth, int texHeight){
