...
//
//	void AddWindow(GLFWwindow*, int width, int height, std::vector<void*>&);
//
...
//
//	void CreateCudaImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VulkanWrapper<VkImage>& image, VulkanWrapper<VkDeviceMemory>& imageMemory);
//
