...
//public:
//
//	VulkanSwapChain(VulkanDevice&, vk::SurfaceKHR&, glm::uvec2&);
...
//
//	void Resize(vk::SurfaceKHR& surface, glm::uvec2 size);
//	void Draw();
//
//private:
//
...
//	bool vSync;
//
//	void BuildSwapChain(VulkanDevice&, vk::SurfaceKHR&, glm::uvec2&, bool);
//};
