...
//
//VulkanPipeline::VulkanPipeline(VulkanDevice& device, vk::Extent2D& extent, const std::string& vertexFilename, const std::string& fragmentFilename, vk::Format swapChainFormat) :
//	renderPass_(device, swapChainFormat), //TODO: remove hardcoded renderpass + allow multiple renderpasses
//	vertexShader_(device, vertexFilename),
//	fragmentShader_(device, fragmentFilename)
//{
//
//	Create(device, extent, swapChainFormat);
//
//}
//
//void VulkanPipeline::Create(VulkanDevice& vkDevice, vk::Extent2D& extent, vk::Format swapChainFormat) {
//
