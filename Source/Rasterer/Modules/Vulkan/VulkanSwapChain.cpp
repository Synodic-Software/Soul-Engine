...
VulkanSwapChain::VulkanSwapChain(EntityManager* entityManager, vk::SurfaceKHR& vkSurface, glm::uvec2& size, bool vSync, VulkanSwapChain* oldSwapChain)
{
...
// void VulkanSwapChain::BuildSwapChain(VulkanDevice& vkDevice, vk::SurfaceKHR& vkSurface, glm::uvec2& size, bool createPipeline) {
//
...
// 	if (createPipeline) {
// 		pipeline_ = std::make_unique<VulkanPipeline>(*entityManager_, vkDevice, swapchainSize, "../../Soul Engine/Resources/Shaders/vert.spv", "../../Soul Engine/Resources/Shaders/frag.spv", format);
// 	} else {
// 		pipeline_->Create(swapchainSize, format);
// 	}
//
// 	for (SwapChainImage& image : images_) {
// 		frameBuffers_.emplace_back(*entityManager_, vkDevice, image.view, pipeline_->GetRenderPass(), size);
// 	}
//
...
VulkanSwapChain::~VulkanSwapChain() {
	...
	//const auto& vkDevice = entityManager_->GetComponent<vk::Device>(device_).GetLogicalDevice();

	//for (const auto& surface : surfaces_) {
	//	vkDevice.destroyImageView(surface.view);
	//}

	//vkDevice.destroySwapchainKHR(swapChain_);

}

//void VulkanSwapChain::Resize(vk::SurfaceKHR& surface, glm::uvec2 size) {
//
//	//pipeline_->Terminate();
...
//	vkDevice.Rebuild();
//
//	BuildSwapChain(vkDevice, surface, size, false);
//
//}
//
